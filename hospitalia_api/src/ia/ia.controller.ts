...
export class IaController {
  ...
  @ApiResponse({ status: 200, description: "IA online", schema: { example: { status: "online" } } })
  checkIA() {
  ...
  @ApiResponse({ status: 200, description: "Banco conectado", schema: { example: { connected: true } } })
  checkDatabase() {
